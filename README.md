...
| **Мультиагентная система** | 33 специализированных агента: `start`, `orchestrator`, `code`, `test-specialist`, `docs-specialist`, `security-auditor` и другие. Делегирование, параллельные ветки, приёмка по доказательствам |
