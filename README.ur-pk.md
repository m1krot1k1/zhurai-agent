...
<p align="center">
  <a href="https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/"><img src="https://img.shields.io/badge/Docs-hermes--agent.nousresearch.com-FFD700?style=for-the-badge" alt="Documentation"></a>
  <a href="https://discord.gg/NousResearch"><img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/m1krot1k1/zhurai-agent/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT"></a>
...
📖 **[مکمل دستاویزات →](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/)**
...
یہ آپ کو OAuth کے ذریعے لاگ ان کرواتا ہے، Nous کو آپ کا پرووائیڈر مقرر کرتا ہے، اور ٹول گیٹ وے کو آن کر دیتا ہے۔ `hermes portal info` کمانڈ استعمال کر کے آپ کسی بھی وقت چیک کر سکتے ہیں کہ کون کون سی سروسز منسلک ہیں۔ مکمل تفصیلات [Tool Gateway دستاویزات کے صفحے](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/tool-gateway) پر موجود ہیں۔
...
مکمل کمانڈ لسٹ کے لیے، [CLI گائیڈ](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/cli) اور [میسجنگ گیٹ وے گائیڈ](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/messaging) دیکھیں۔

---

## دستاویزات (Documentation)

تمام دستاویزات **[raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/)** پر موجود ہیں:

<div dir="ltr">

| سیکشن (Section)                                                                                     | تفصیل (What's Covered)                                     |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [فوری آغاز (Quickstart)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/getting-started/quickstart)     | انسٹالیشن → سیٹ اپ → 2 منٹ میں پہلی بات چیت شروع کریں       |
| [CLI کا استعمال](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/cli)                         | کمانڈز، کی بائنڈنگز (keybindings)، پرسنلٹیز (personalities)، سیشنز |
| [کنفیگریشن (Configuration)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/configuration)    | کنفگ فائل، پرووائیڈرز، ماڈلز، اور تمام آپشنز               |
| [میسجنگ گیٹ وے](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/messaging)                    | ٹیلی گرام، ڈسکارڈ، سلیک، واٹس ایپ، سگنل، ہوم اسسٹنٹ         |
| [سیکیورٹی (Security)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/security)              | کمانڈ کی منظوری، DM پیئرنگ (pairing)، کنٹینر آئسولیشن       |
| [ٹولز اور ٹول سیٹس](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/tools)          | 40 سے زائد ٹولز، ٹول سیٹ سسٹم، ٹرمینل بیک اینڈز             |
| [مہارتوں کا سسٹم (Skills System)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/skills)| پروسیجرل (Procedural) میموری، سکلز ہب، نئی مہارتیں بنانا    |
| [میموری (Memory)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/memory)            | مستقل میموری، یوزر پروفائلز، بہترین طریقہ کار              |
| [MCP انضمام (Integration)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/mcp)      | صلاحیتوں کو بڑھانے کے لیے کسی بھی MCP سرور کو جوڑیں        |
| [کرون (Cron) شیڈیولنگ](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/cron)         | پلیٹ فارم ڈیلیوری کے ساتھ شیڈول کیے گئے کام                 |
| [کانٹیکسٹ (Context) فائلز](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/user-guide/features/context-files)| پروجیکٹ کا سیاق و سباق (context) جو ہر بات چیت پر اثر انداز ہوتا ہے |
| [آرکیٹیکچر (Architecture)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/developer-guide/architecture) | پروجیکٹ کا ڈھانچہ، ایجنٹ لوپ، اہم کلاسز                    |
| [تعاون (Contributing)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/developer-guide/contributing)     | ڈیویلپمنٹ سیٹ اپ، PR کا طریقہ کار، کوڈنگ کا انداز          |
| [CLI حوالہ جات (Reference)](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/reference/cli-commands)      | تمام کمانڈز اور فلیگز (flags)                              |
| [انوائرمنٹ ویری ایبلز](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/reference/environment-variables)  | مکمل انوائرمنٹ ویری ایبل حوالہ جات                         |
...
ہم آپ کے تعاون کا خیرمقدم کرتے ہیں! ڈیویلپمنٹ سیٹ اپ، کوڈ کے انداز اور PR کے طریقہ کار کے لیے براہ کرم ہماری [Contributing گائیڈ](https://raw.githubusercontent.com/m1krot1k1/zhurai-agent/main/docs/developer-guide/contributing) دیکھیں۔
...
- 🐛 [مسائل (Issues)](https://github.com/m1krot1k1/zhurai-agent/issues)
