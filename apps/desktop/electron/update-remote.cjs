 ...
 *
 * A public install can end up with `origin=git@github.com:m1krot1k1/zhurai-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/m1krot1k1/zhurai-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/m1krot1k1/zhurai-agent'
