...
import { AgentLink, agentIdFromMarkdownHref } from '@/components/assistant-ui/agent-link'
...
function MarkdownLink({ children, className, href, ...props }: ComponentProps<'a'>) {
  ...
  const agentId = agentIdFromMarkdownHref(href)

  if (agentId) {
    return (
      <AgentLink agentId={agentId} className={className}>
        {children}
      </AgentLink>
    )
  }
