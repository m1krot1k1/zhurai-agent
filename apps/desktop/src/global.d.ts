...
declare global {
  interface Window {
    hermesDesktop: {
      ...
      /** Scan repo `agents/*.md` from ZHUR_AI_AGENT_ROOT or hermesRoot. */
      listRepoAgents?: () => Promise<HermesRepoAgentDiscoveryResult>
...
export interface HermesRepoAgentDescriptor {
  description: string
  fileName: string
  id: string
  name: string
...
export interface HermesRepoAgentDiscoveryResult {
  agents: HermesRepoAgentDescriptor[]
  error?: string
  root: string | null
}
