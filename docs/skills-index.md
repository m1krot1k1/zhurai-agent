...
| headroom | [skills/mcp/headroom/SKILL.md](../skills/mcp/headroom/SKILL.md) · [optional MCP](../optional-mcps/headroom/README.md) | Headroom proxy stats, MCP compression, savings dashboard. |
