...
$RepoUrlSsh = "git@github.com:m1krot1k1/zhurai-agent.git"
$RepoUrlHttps = "https://github.com/m1krot1k1/zhurai-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/m1krot1k1/zhurai-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/m1krot1k1/zhurai-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/m1krot1k1/zhurai-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
