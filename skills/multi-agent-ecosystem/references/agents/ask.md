...
- Load via `multi-agent-ecosystem` skill → `references/agents/ask.md`.
...
<!--ШПАРГАЛКА (ask)
  ...
  ПРИМЕР: delegate to ask (references/agents/ask.md, "Объясни как работает цепочка middleware аутентификации в src/middleware/")
-->
...
- **agent-system-navigation**: `../skills/agent-system-navigation.md` — Быстрая навигация по агентам, паттернам делегирования и маршрутизации запросов для точных ответов без изменений кода.
