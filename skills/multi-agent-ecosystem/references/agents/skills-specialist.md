...
- Load via `multi-agent-ecosystem` skill → `references/agents/skills-specialist.md`.
...
<!--ШПАРГАЛКА (skills-specialist)
  ...
  ПРИМЕР: delegate to skills-specialist (references/agents/skills-specialist.md, "Создать skill для workflow security-review")
-->
...
- `pr-agent-workflow/` → Переименован в **start-workflow** (см. `../skills/start-workflow.md`)
