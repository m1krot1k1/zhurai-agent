...
- `orchestrator.md` — текстовые шаблоны конверта
- `agent-prompt-quality.md` — обязательные секции промпта
- `agent-evals.md` — когда менять core и как версионировать evals
