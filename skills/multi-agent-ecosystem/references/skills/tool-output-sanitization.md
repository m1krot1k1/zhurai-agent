...
- [ ] При мультимодальных данных применён quarantine (см. `../rules/aleksander.mdc` 2.6.1)
...
- `mcp-governance.md` — доверие к MCP и конфигам
- `session-memory-tiers.md` — куда писать после санитизации
